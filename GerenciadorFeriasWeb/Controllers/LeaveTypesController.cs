...
namespace GerenciadorFeriasWeb.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DefaultDays,CreatedDate,ModifiedDate")] LeaveType leaveType)
        {
            if (id != leaveType.Id)
            {
                return NotFound();
